  ...
  <div class="nav-bar">
    ...
    <div class="left-nav">
        <el-menu :default-active="activeIndex2" class="el-menu-demo" mode="horizontal" @select="handleSelect">
          <el-menu-item index="1" @click="showWelcome()">首 页</el-menu-item>
    ...
    <div class="right-nav">
      <el-menu class="el-menu-demo" mode="horizontal">
        <el-menu-item index="1" @click="showLogIn()" v-show="!loginState">登 录</el-menu-item>
        <el-menu-item index="2" @click="showSignIn()" v-show="!loginState">注 册</el-menu-item>
